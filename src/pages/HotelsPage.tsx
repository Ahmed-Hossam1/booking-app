...
const HotelsPage = () => {
    ...
    const cities = ["All", "Cairo", "Hurghada", "Sharm El Sheikh", "Alexandria", "Luxor"];
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative h-[65vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl">
                    ...
                    <p className="text-lg md:text-xl text-white/90 mb-8 drop-shadow-md">
                        Discover luxury hotels, boutique stays, and cozy resorts tailored for your unforgettable journey.
                    </p>
            ...
            <div className="bg-white border-b border-gray-100 py-8 relative z-20 -mt-10 mx-auto max-w-6xl rounded-xl shadow-xl px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">We match any price you find.</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <div className="bg-[#EB662B]/10 p-4 rounded-full">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Flexible bookings for your peace of mind.</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <div className="bg-[#EB662B]/10 p-4 rounded-full">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-[#05073C]">Explore Our Destinations</h2>
                    <p className="text-gray-500 mt-2">Take a glimpse at some of our most stunning properties.</p>
                </div>
            ...
            <div id="hotels-list" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                {/* Search & Filter Header */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div>
                        <h2 className="text-3xl font-bold text-[#05073C]">Available Hotels</h2>
                        <p className="text-gray-500 mt-1">Showing the best results in your selected location.</p>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-4 flex-grow max-w-2xl bg-white p-2 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <p className="text-sm text-gray-500 line-clamp-2 mb-6">
                                    Experience the ultimate comfort and hospitality with world-class amenities and stunning views.
                                </p>

                                <div className="flex items-center justify-between mt-auto pt-6 border-t border-gray-50">
                                    <div>
                                        <p className="text-xs text-gray-400 uppercase font-bold">Starts from</p>
                                        <div className="flex items-baseline gap-1">
                                            <span className="text-2xl font-black text-[#05073C]">${hotel.price}</span>
                ...
                {filteredHotels.length === 0 && (
                    <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-gray-300">
                        <h3 className="text-2xl font-bold text-gray-400">No matching hotels found.</h3>
            ...
            <SectionWrapper className="bg-white py-24 px-6 md:px-12 rounded-3xl mb-20 shadow-sm border border-gray-100">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-[#05073C]">World-Class Amenities</h2>
                    <p className="text-gray-500 mt-2">Everything you need for a comfortable and luxury stay.</p>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    {amenities.map((item, index) => (
                        <div key={index} className="flex flex-col items-center gap-4 group">
                            ...
                            <span className="text-sm font-bold text-[#05073C] text-center">{item.name}</span>
                        </div>
                    ))}
                </div>
            </SectionWrapper>
            ...
            <SectionWrapper className="mb-20">
                <div className="relative overflow-hidden rounded-3xl bg-[#05073C] p-8 md:p-16">
                    <div className="relative z-10 max-w-2xl">
                        <span className="text-[#EB662B] font-bold tracking-widest uppercase text-sm">Join the Club</span>
                        <h2 className="text-white text-3xl md:text-5xl font-extrabold mt-4 leading-tight">
                            Save up to <span className="text-[#EB662B]">20% extra</span> with our membership
                        </h2>
                        <p className="text-white/70 mt-6 text-lg">
                            Sign up for free and get instant access to member-only prices on thousands of hotels worldwide.
                        </p>
                        <div className="mt-10 flex flex-col sm:flex-row gap-4">
                            <Button className="px-10 py-4 rounded-xl text-white font-bold">Join Now for Free</Button>
                            <Button backgroundColor="transparent" className="px-10 py-4 rounded-xl text-white font-bold border border-white/20 hover:bg-white/5">Learn More</Button>
                        </div>
                    </div>
